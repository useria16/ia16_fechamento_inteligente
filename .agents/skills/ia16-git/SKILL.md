...
Não salvar token em `.env`, `.Codex/`, `settings.json` ou qualquer arquivo versionado.
...
```bash
git checkout -b feature/configuracao-Codex
...
```bash
git commit -m "chore: adiciona configuracao do Codex"
